...
describe("InputService", () => {
  ...
  describe("getInputs", () => {
    ...
    describe("service-log-level", () => {
      it("should return given service-log-level input", () => {
        getInputMock.mockImplementation((inputName) => {
          switch (inputName) {
      ...
      it("should return default service-log-level input", () => {
        getInputMock.mockImplementation((inputName) => {
          switch (inputName) {
            case InputNames.ServiceLogLevel:
              return "";
      ...
      it("should throw an error when service-log-level input is invalid", () => {
        getInputMock.mockImplementation((inputName) => {
          switch (inputName) {
            case InputNames.ServiceLogLevel:
